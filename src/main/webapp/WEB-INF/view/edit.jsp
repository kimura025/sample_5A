			...
			<div class="card mb-3">
				...
				<div class="card-body">
					<div>
						...
						<div class="mb-3">
							<label class="form-label" for="item_price">価格：</label> <input
								type="number" class="form-control" id="item_price" name="item_price"
								value="<c:out value="${item.itemPrice}" />" min="1" max="9999999999"
								maxlength="10" required>
						</div>
						<div class="mb-3">
							<label class="form-label" for="item_regist">仮登録： </label> <input
								type="checkbox" id="item_regist" name="item_regist">
						</div>
					</div>
